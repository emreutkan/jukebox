...
from Network import scan_for_networks, scan_for_networks_by_OUI, process_ssids, Deauth, Deauth_By_OUI,scan_devices_in_AP,scan_devices_in_AP_Select_Device
...
def test8():
    scan_devices_in_AP_Select_Device('wlan0','SUPERONLINE_Wi-Fi_1248')
